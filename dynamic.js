...
function education(edu){
  ...
  etable.border="1";
  var tr1="<tr><td>S.No.</td><td>Name of the Institute</td><td>Year of Passing</td></tr>";
  var tr2="";
  for(i=0;i<edu.length;i++){
    tr2=tr2+"<tr><td>"+edu[i].s.no+"</td><td>"+edu[i].Institute+"</td><td>"+edu[i].YOP+"</td></tr>";
  }
...
function technical(tec){
  ...
  thead.textContent="Skills";
  child2.appendChild(thead);
  var tul=document.createElement("ul");
  child2.appendChild(tul);
  for(i=0;i<tec.length;i++){
    var li=document.createElement("li");
    li.textContent=tec[i].title+":"+tec[i].content;
    ul.appendChild(li);
  }
}
